...
| Tool | Shell | Python | PowerShell | CMD | Rust | Description |
| --- | --- | --- | --- | --- | --- | --- |
...
| pasta | [sh](sh/pasta) | [py](py/pasta.py) | [ps1](ps/pasta.ps1) | — | [rs](rs/crates/pasta/src/main.rs) | Prints clipboard contents with platform-specific fallbacks. |
